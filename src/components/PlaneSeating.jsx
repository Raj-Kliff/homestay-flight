...
const PlaneSeating = () => {
  return (
    <div className="relative flex flex-col sm:flex-row">
      <div className="seat-details absolute top-0 left-[5%]">
        <ul>
          <li className="flex items-center gap-2">
            <div className="box taken bg-[#dedede66] border-[#dedede22] border-2 w-[25px] h-[25px] rounded" />
            <h6>Taken</h6>
          </li>
          <li className="flex items-center gap-2 mt-2">
            <div className="box selected  bg-[#d4e990] border-[#bada22] border w-[25px] h-[25px] rounded" />
            <h6>Selected</h6>
          </li>
          <li className="flex items-center gap-2 mt-2">
            <div className="box available bg-[#4291b840] border-[#4291b840] border w-[25px] h-[25px] rounded" />
            <h6>Available</h6>
          </li>
        </ul>
      </div>
        ...
        <ol className="cabin fuselage">
          <li className="row row--1">
            <ol className="seats" type="A">
              ...
              <li className="seat">
                <input type="checkbox" disabled="true" id="1D" />
                <label htmlFor="1D">X</label>
              </li>
              <li className="seat">
