...
const FlightDateRangeInput = ({
  ...
  const [endDate, setEndDate] = useState(null); // end date starts as null

  const onChangeRangeDate = (dates) => {
    const [start, end] = dates;
    setStartDate(start);
    setEndDate(end); // Update both start and end dates
  };
        ...
        {({ open }) => (
          <>
            ...
            >
              ...
              {/* <a
                type="button"
                className="flex h-14 sm:ms-5 mt-5 sm:mt-0 w-full items-center justify-center rounded-full bg-purple-500 text-white hover:bg-purple-600 focus:outline-none md:h-16 md:w-16"
